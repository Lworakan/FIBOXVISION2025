...
# --- การตั้งค่าโมเดล ---
YOLO_MODEL_PATH = (
    r"../best.pt"  # ตำแหน่งไฟล์โมเดล YOLO -> สำหรับ Production (แก้ path ให้ชี้ไปที่ root)
)
...
ESTIMATED_FOCAL_LENGTH = 716  # ค่า Focal Length โดยประมาณ (หน่วย pixel) - ควร Calibrate
